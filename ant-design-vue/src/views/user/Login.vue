    ...
    <div class="main">
                ...
                <a-tab-pane key="tab1" tab="账号密码登陆">
                    ...
                    <a-row :gutter="0">
                        ...
                        <a-col :span="8" style="text-align: right">
                            <img :src="randCodeImage" @click="handleChangeCheckCode" style="margin-top: 2px;" v-if="requestCodeSuccess"/>
                            <img @click="handleChangeCheckCode" src="../../assets/checkcode.png" style="margin-top: 2px;" v-else/>
                        </a-col>
                    </a-row>
        ...
        <a-modal
            ...
            <template slot="footer">
                <a-button @click="departOk" type="primary">确认</a-button>
            </template>
            ...
            <a-form>
                <a-form-item
                    ...
                    <a-select :class="{'valid-error':validate_status=='error'}" @change="departChange" placeholder="请选择登录部门" style="margin-left:10px;width: 80%">
