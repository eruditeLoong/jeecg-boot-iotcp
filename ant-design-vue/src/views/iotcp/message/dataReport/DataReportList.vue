                ...
                <a-row :gutter="24">
                    <a-col :lg="7" :md="8" :sm="24" :xl="6">
                        <a-form-item label="实例设备">
                            <j-search-select-tag dict="iot_device_instance,name,id" placeholder="请选择实例设备" v-model="queryParam.instanceDeviceBy"/>
                        </a-form-item>
                    </a-col>
                    <!--                    <a-col :lg="7" :md="8" :sm="24" :xl="6">-->
                    <!--                        <a-form-item label="上报数据">-->
                    <!--                            <a-input placeholder="请输入上报数据" v-model="queryParam.data"></a-input>-->
                    <!--                        </a-form-item>-->
                    <!--                    </a-col>-->
