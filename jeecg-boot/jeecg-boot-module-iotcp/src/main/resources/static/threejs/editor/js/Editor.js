...
import {LoaderRemote} from './Loader.Remote.js';
import {History as _History} from './History.js';
import {Strings} from './Strings.js';
import {Storage as _Storage} from './Storage.js';
import {SceneConf} from './Config.Scene.js';
...
var Editor = function () {
    ...
    this.BASE_URL = this.getQueryVariable('baseUrl');
    ...
    this.sceneConf = new SceneConf(this);
...
Editor.prototype = {
    ...
    configObj: function (object, sceneParams, type) {
        console.log('configObj >>> ', object, sceneParams)
        object = object.scene || object;
        object.uuid = sceneParams.id;
        object.name = sceneParams.name;
        object.userData['modelFiles'] = sceneParams.modelFiles;
        object.userData['modelType'] = type;

        if(sceneParams.config){
            let position = sceneParams.config['position'];
            let rotation = sceneParams.config['rotation'];
            let scale = sceneParams.config['scale'];
